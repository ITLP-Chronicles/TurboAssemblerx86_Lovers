...
code segment
    ...
    start:
        ...
        File_Create filename, handler ; Use File_Create
        ...
        Console_WriteTextWith0 newLine
        File_Write handler, bytesToWrite, textToWrite, bytesWritten ; Use File_Write
        ...
        Console_WriteTextWith0 newLine
        File_Open filename, handler, 0  ; Pass filename, handler var, mode 0
